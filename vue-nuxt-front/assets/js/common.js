...
var scrollLoad = function(options) {
  ...
  var _init = function() {
    ...
    var docImg = document.getElementById('aCoursesList').getElementsByTagName('img')			// 通过ID查找获取图片节点
    var _len = docImg.length
    if (!_len) return false
    for (var i = 0; i < _len; i++) {
      var attrSrc = docImg[i].getAttribute(defaults.src)
      var o = docImg[i]; var tag = o.nodeName.toLowerCase()
      if (o) {
...
function dialog(dTitle, msg, index, url) {
  ...
  var dialogEle = $('<div class="dialogWrap"><div class="dialog-ele"><h4 class="d-s-head pr"><a href="javascript:void(0)" title="关闭" class="dClose icon16 pa">&nbsp;</a><span class="d-s-head-txt">' + dTitle + '</span></h4><div class="of"><div id="dcWrap" class="mt20 mb20 ml20 mr20 "></div></div></div></div>').appendTo($('body'))
  var dCont = [
  ...
  var dW = dialogEle.width()
  var dHead = $('.dialog-ele>h4')
