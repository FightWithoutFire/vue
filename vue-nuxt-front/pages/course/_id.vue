        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt">
              <a v-if="isBuy || Number(courseWebVo.price) === 0 " href="#" title="立即观看" class="comm-btn c-btn-3">立即观看</a>
              <a v-if="!isBuy && Number(courseWebVo.price) !== 0 " href="#" title="立即购买" class="comm-btn c-btn-3" @click="createOrder()">立即购买</a>
            </section>
          </section>
        </aside>
